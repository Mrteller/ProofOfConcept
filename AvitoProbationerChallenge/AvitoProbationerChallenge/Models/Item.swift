...
struct Item: Hashable {
    ...
    static var fakeItems: [Item] {
        var array: [Item] = []
        array.append(Item(id: UUID().uuidString, name: "Stolen Things", year: 2019, cover: UIImage(named: "stolen"), amountPages: 368,
        ...
        array.append(Item(id: UUID().uuidString, name: "Here There Are Monsters", year: 2018, cover: UIImage(named: "monsters"), amountPages: 352,
        ...
        array.append(Item(id: UUID().uuidString, name: "All the Bad Apples", year: 2019, cover: UIImage(named: "apples"), amountPages: 320,
        ...
        array.append(Item(id: UUID().uuidString, name: "All the Lovely Pieces", year: 2017, cover: UIImage(named: "pieces"), amountPages: 320,
        ...
        array.append(Item(id: UUID().uuidString, name: "Drowning With Others", year: 2015, cover: UIImage(named: "others"), amountPages: 379,
        ...
        array.append(Item(id: UUID().uuidString, name: "Winter Cottage", year: 2018, cover: UIImage(named: "winter"), amountPages: 348,
